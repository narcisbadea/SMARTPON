...
import kotlinx.android.synthetic.main.activity_connect.scan_button
import kotlinx.android.synthetic.main.activity_connect.scan_results_recycler_view
    ...
    private val scanResultAdapter: ScanResultAdapter by lazy {
        ScanResultAdapter(scanResults) { result ->
            ...
            with(result.device) {
                ...
                ConnectionManager.connect(this, this@Connect)
            }
        }
    }
    ...
    private val connectionEventListener by lazy {
        ConnectionEventListener().apply {
            onConnectionSetupComplete = { gatt ->
                Intent(this@Connect, BleOperationsActivity::class.java).also {
